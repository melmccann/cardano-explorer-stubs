...
class InlineResponse2007 implements ModelInterface, ArrayAccess
{
     ...
     * Sets right
     *
     * @param object[] $right First item is a page number, second item is an array of 2-tuples where for each 2-tuple:  - The first element is a transaction hash. - The second element is the size of that transaction in `bytes`.
     *
     * @return $this
     */
