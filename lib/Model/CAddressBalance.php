 ...
 * @link     https://openapi-generator.tech
 */
class CAddressBalance implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CAddressBalance';
    ...
    public function setIndex($index)
    {
        ...
        if (($index > 65535)) {
            throw new \InvalidArgumentException('invalid value for $index when calling CAddressBalance., must be smaller than or equal to 65535.');
        }
        if (($index < 0)) {
            throw new \InvalidArgumentException('invalid value for $index when calling CAddressBalance., must be bigger than or equal to 0.');
        }
