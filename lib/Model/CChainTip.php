 ...
 * @link     https://openapi-generator.tech
 */
class CChainTip implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CChainTip';
    ...
    public function setCtBlockNo($ct_block_no)
    {
        ...
        if (!is_null($ct_block_no) && ($ct_block_no < 0)) {
            throw new \InvalidArgumentException('invalid value for $ct_block_no when calling CChainTip., must be bigger than or equal to 0.');
        }
    ...
    public function setCtSlotNo($ct_slot_no)
    {
        ...
        if (!is_null($ct_slot_no) && ($ct_slot_no < 0)) {
            throw new \InvalidArgumentException('invalid value for $ct_slot_no when calling CChainTip., must be bigger than or equal to 0.');
        }
    ...
    public function setCtBlockHash($ct_block_hash)
    {
        if (!is_null($ct_block_hash) && (mb_strlen($ct_block_hash) > 64)) {
            throw new \InvalidArgumentException('invalid length for $ct_block_hash when calling CChainTip., must be smaller than or equal to 64.');
        }
        if (!is_null($ct_block_hash) && (mb_strlen($ct_block_hash) < 64)) {
            throw new \InvalidArgumentException('invalid length for $ct_block_hash when calling CChainTip., must be bigger than or equal to 64.');
        }
        if (!is_null($ct_block_hash) && (!preg_match("/^[0-9a-f]{64}$/", $ct_block_hash))) {
            throw new \InvalidArgumentException("invalid value for $ct_block_hash when calling CChainTip., must conform to the pattern /^[0-9a-f]{64}$/.");
        }
