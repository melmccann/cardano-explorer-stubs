 ...
 * @link     https://openapi-generator.tech
 */
class CBlockEntry implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CBlockEntry';
    ...
    public function setCbeEpoch($cbe_epoch)
    {
        ...
        if (($cbe_epoch < 0)) {
            throw new \InvalidArgumentException('invalid value for $cbe_epoch when calling CBlockEntry., must be bigger than or equal to 0.');
        }
    ...
    public function setCbeSlot($cbe_slot)
    {
        ...
        if (($cbe_slot > 65535)) {
            throw new \InvalidArgumentException('invalid value for $cbe_slot when calling CBlockEntry., must be smaller than or equal to 65535.');
        }
        if (($cbe_slot < 0)) {
            throw new \InvalidArgumentException('invalid value for $cbe_slot when calling CBlockEntry., must be bigger than or equal to 0.');
        }
    ...
    public function setCbeBlkHeight($cbe_blk_height)
    {
        ...
        if (($cbe_blk_height < 0)) {
            throw new \InvalidArgumentException('invalid value for $cbe_blk_height when calling CBlockEntry., must be bigger than or equal to 0.');
        }
    ...
    public function setCbeBlkHash($cbe_blk_hash)
    {
        if ((mb_strlen($cbe_blk_hash) > 64)) {
            throw new \InvalidArgumentException('invalid length for $cbe_blk_hash when calling CBlockEntry., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($cbe_blk_hash) < 64)) {
            throw new \InvalidArgumentException('invalid length for $cbe_blk_hash when calling CBlockEntry., must be bigger than or equal to 64.');
        }
        if ((!preg_match("/^[0-9a-f]{64}$/", $cbe_blk_hash))) {
            throw new \InvalidArgumentException("invalid value for $cbe_blk_hash when calling CBlockEntry., must conform to the pattern /^[0-9a-f]{64}$/.");
        }
    ...
    public function setCbeTxNum($cbe_tx_num)
    {
        ...
        if (($cbe_tx_num < 0)) {
            throw new \InvalidArgumentException('invalid value for $cbe_tx_num when calling CBlockEntry., must be bigger than or equal to 0.');
        }
    ...
    public function setCbeSize($cbe_size)
    {
        ...
        if (($cbe_size < 0)) {
            throw new \InvalidArgumentException('invalid value for $cbe_size when calling CBlockEntry., must be bigger than or equal to 0.');
        }
    ...
    public function setCbeBlockLead($cbe_block_lead)
    {
        if (!is_null($cbe_block_lead) && (mb_strlen($cbe_block_lead) > 64)) {
            throw new \InvalidArgumentException('invalid length for $cbe_block_lead when calling CBlockEntry., must be smaller than or equal to 64.');
        }
        if (!is_null($cbe_block_lead) && (mb_strlen($cbe_block_lead) < 64)) {
            throw new \InvalidArgumentException('invalid length for $cbe_block_lead when calling CBlockEntry., must be bigger than or equal to 64.');
        }
        if (!is_null($cbe_block_lead) && (!preg_match("/^[0-9a-f]{64}$/", $cbe_block_lead))) {
            throw new \InvalidArgumentException("invalid value for $cbe_block_lead when calling CBlockEntry., must conform to the pattern /^[0-9a-f]{64}$/.");
        }
