...
/**
 * CGenesisSummary Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class CGenesisSummary implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CGenesisSummary';
    ...
    public function setCgsNumTotal($cgs_num_total)
    {
        ...
        if (($cgs_num_total < 0)) {
            throw new \InvalidArgumentException('invalid value for $cgs_num_total when calling CGenesisSummary., must be bigger than or equal to 0.');
        }
    ...
    public function setCgsNumRedeemed($cgs_num_redeemed)
    {
        ...
        if (($cgs_num_redeemed < 0)) {
            throw new \InvalidArgumentException('invalid value for $cgs_num_redeemed when calling CGenesisSummary., must be bigger than or equal to 0.');
        }
    ...
    public function setCgsNumNotRedeemed($cgs_num_not_redeemed)
    {
        ...
        if (($cgs_num_not_redeemed < 0)) {
            throw new \InvalidArgumentException('invalid value for $cgs_num_not_redeemed when calling CGenesisSummary., must be bigger than or equal to 0.');
        }
