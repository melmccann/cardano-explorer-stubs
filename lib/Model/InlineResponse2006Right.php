 ...
 * @link     https://openapi-generator.tech
 */
class InlineResponse2006Right implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_200_6_Right';
    ...
    public function setCtsBlockHeight($cts_block_height)
    {
        ...
        if (!is_null($cts_block_height) && ($cts_block_height < 0)) {
            throw new \InvalidArgumentException('invalid value for $cts_block_height when calling InlineResponse2006Right., must be bigger than or equal to 0.');
        }
    ...
    public function setCtsBlockEpoch($cts_block_epoch)
    {
        ...
        if (!is_null($cts_block_epoch) && ($cts_block_epoch < 0)) {
            throw new \InvalidArgumentException('invalid value for $cts_block_epoch when calling InlineResponse2006Right., must be bigger than or equal to 0.');
        }
    ...
    public function setCtsBlockSlot($cts_block_slot)
    {
        ...
        if (!is_null($cts_block_slot) && ($cts_block_slot > 65535)) {
            throw new \InvalidArgumentException('invalid value for $cts_block_slot when calling InlineResponse2006Right., must be smaller than or equal to 65535.');
        }
        if (!is_null($cts_block_slot) && ($cts_block_slot < 0)) {
            throw new \InvalidArgumentException('invalid value for $cts_block_slot when calling InlineResponse2006Right., must be bigger than or equal to 0.');
        }
    ...
    public function setCtsBlockHash($cts_block_hash)
    {
        if (!is_null($cts_block_hash) && (mb_strlen($cts_block_hash) > 64)) {
            throw new \InvalidArgumentException('invalid length for $cts_block_hash when calling InlineResponse2006Right., must be smaller than or equal to 64.');
        }
        if (!is_null($cts_block_hash) && (mb_strlen($cts_block_hash) < 64)) {
            throw new \InvalidArgumentException('invalid length for $cts_block_hash when calling InlineResponse2006Right., must be bigger than or equal to 64.');
        }
        if (!is_null($cts_block_hash) && (!preg_match("/^[0-9a-f]{64}$/", $cts_block_hash))) {
            throw new \InvalidArgumentException("invalid value for $cts_block_hash when calling InlineResponse2006Right., must conform to the pattern /^[0-9a-f]{64}$/.");
        }
