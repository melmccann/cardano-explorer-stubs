 ...
 * @link     https://openapi-generator.tech
 */
class CCoin implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CCoin';
    ...
    public function setGetCoin($get_coin)
    {
        ...
        if (($get_coin < 0)) {
            throw new \InvalidArgumentException('invalid value for $get_coin when calling CCoin., must be bigger than or equal to 0.');
        }
