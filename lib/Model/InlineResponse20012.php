...
class InlineResponse20012 implements ModelInterface, ArrayAccess
{
    ...
    public function setRight($right)
    {
        ...
        if (($right < 0)) {
            throw new \InvalidArgumentException('invalid value for $right when calling InlineResponse20012., must be bigger than or equal to 0.');
        }
