 ...
 * @link     https://openapi-generator.tech
 */
class InlineResponse2008Right implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_200_8_Right';
    ...
    public function setCaTxNum($ca_tx_num)
    {
        ...
        if (($ca_tx_num < 0)) {
            throw new \InvalidArgumentException('invalid value for $ca_tx_num when calling InlineResponse2008Right., must be bigger than or equal to 0.');
        }
